"use strict";
const CACHE="apprenticeship-plus-install-button-fix-v3";
...
self.addEventListener("fetch",e=>{
 ...
 if(rootPage){
  e.respondWith(fetch(e.request,{cache:"no-store"}).then(r=>r.text()).then(html=>{
   const tags='<link rel="stylesheet" href="./install-apprenticeship-plus.css?v=3"><script defer src="./install-apprenticeship-plus.js?v=3"></scr'+'ipt>';
