"use strict";
(function(){
  if(window.__AP_PRO_NAV__) return;
  window.__AP_PRO_NAV__ = true;
  ...
  function initialise(){
    ...
    if(!select || select.dataset.professionalNavigation) return;
    select.dataset.professionalNavigation = "true";
