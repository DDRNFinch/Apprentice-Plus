...
const WORKBENCH_CATEGORY_META={"Tools":{"icon":"🛠️","description":"Bricklaying hand tools and checking equipment."},"Materials":{"icon":"🧱","description":"Bricks, blocks and mortar materials."},"Components":{"icon":"🧩","description":"DPCs, ties, insulation and lintels."},"Bonds":{"icon":"🏛️","description":"Common brick bonds and bonding principles."},"Construction":{"icon":"🏠","description":"Setting out, solid walls and cavity walls."},"Joint Finishes":{"icon":"➖","description":"Common mortar joint finishes."},"Decorative Work":{"icon":"✨","description":"Soldier courses, brick-on-edge and features."},"Repairs":{"icon":"🛠️","description":"Repair and movement principles."},"Specialist Work":{"icon":"📐","description":"More advanced bricklaying details."},"Safety":{"icon":"⚠️","description":"PPE, RPE, RAMS and COSHH."}};
...
function workbench(){
  ...
  view().innerHTML=`
    <section class="card hero workbench-hero">
      ...
      <h2>🧰 Workbench</h2>
      <p>Search practical UK bricklaying reference cards for tools, materials, components, bonds, construction, finishes and safety.</p>
